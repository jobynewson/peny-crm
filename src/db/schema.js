...
export const projects = pgTable('projects', {
  ...
  portal_show_budget:   boolean('portal_show_budget').notNull().default(false),
  portal_show_shoots:   boolean('portal_show_shoots').notNull().default(false),
  portal_show_planning: boolean('portal_show_planning').notNull().default(false),
